...
public class TripDetail {
    ...
    public TripDetail(String username, String phone, String departure, String destination, String dateDeparture, String dateDestination, Double departureCoordinates, Double destinationCoordinates) {
